...
public class SuperMain extends AppCompatActivity {
    private Button verifyemail,upload;
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SuperMain.this,SuperUploadPage.class);
    ...
    public void ClickDashboard(View view){
        redirectActivity(SuperMain.this,SuperDashboard.class);
    }

    public void ClickAboutUs(View view){
        redirectActivity(SuperMain.this,SuperAboutUs.class);
    }
            ...
            reset_alert.setTitle("Update Email").setMessage("Enter New Email Address").setPositiveButton("Update", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    user.updateEmail(email.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(SuperMain.this, "Email Updated", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(SuperMain.this,e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            ...
            reset_alert.setTitle("Delete Account Permanently ?").setMessage("Are You Sure?").setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    user.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(SuperMain.this, "Account Deleted", Toast.LENGTH_SHORT).show();

...
public class HomeMain extends AppCompatActivity {
    Button verifyemail,upload,Google,Chatbot;
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        Google = findViewById(R.id.maps);


        Google.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeMain.this,HomeMaps.class);
    ...
    public void ClickDashboard(View view){
        redirectActivity(HomeMain.this,HomeDashboard.class);
    }

    public void ClickAboutUs(View view){
        redirectActivity(HomeMain.this,HomeAboutUs.class);
    }
            ...
            reset_alert.setTitle("Update Email").setMessage("Enter New Email Address").setPositiveButton("Update", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    user.updateEmail(email.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(HomeMain.this, "Email Updated", Toast.LENGTH_SHORT).show();
                        }
            ...
            reset_alert.setTitle("Delete Account Permanently ?").setMessage("Are You Sure?").setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    user.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(HomeMain.this, "Account Deleted", Toast.LENGTH_SHORT).show();

                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        firebaseAuth.sendPasswordResetEmail(email.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(SuperLogin.this, "Email to reset password has been sent", Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(SuperLogin.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
            ...
            public void onClick(View v) {
                ...
                firebaseAuth.signInWithEmailAndPassword(useremail.getText().toString(), userpassword.getText().toString()).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                      startActivity(new Intent(getApplicationContext(), SuperMain.class));
                        finish();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override

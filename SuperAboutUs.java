...
public class SuperAboutUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_super_about_us);
        ...
        gmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SuperAboutUs.this,Email.class);
                startActivity(intent);
            }
        });
    }

    public void ClickMenu(View view){SuperMain.openDrawer(drawerLayout);
    }
    ...
    public void ClickDashboard(View view){
        SuperMain.redirectActivity(this,SuperDashboard.class);
    }
